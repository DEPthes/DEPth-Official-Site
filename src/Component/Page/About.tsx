...
const About = () => {
    ...
    const curriculumBoxes1 = [
        ...
        },
        {
            ...
            header: 'MVP Project',
            content:
                '협업 경험을 위한 4주 간의 단기 프로젝트입니다. 최소 실현 가능한 제품이라는 MVP의 성격을 토대로 협업 경험, Study 복습과 실현, 회고와 피드백을 추구하며 진행됩니다.',
        },
    ];
    const curriculumBoxes2 = [
        ...
        },
        {
            ...
            header: 'Demo Day',
            content:
                '프로젝트 종료 시점, 전체 회원이 모여 팀 별로 서비스를 소개하고 체험하며 피드백을 주고 받는 행사입니다.',
        },
        {
            id: 'Networking',
            header: 'Networking',
